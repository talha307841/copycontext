...
// Generate button (always uses NIM)
qs('cs-generate-btn').onclick = () => {
  ...
  showStatus('Summarizing with NVIDIA NIM...');
  setLoading(true);
  chrome.runtime.sendMessage({
    ...
    if (resp?.usedFallback) {
      showStatus('⚠️ NIM unavailable — using local summary. Add your API key in Settings.', 'error');
